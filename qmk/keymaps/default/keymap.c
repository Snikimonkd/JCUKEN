    ...
    [_QWERTY] = LAYOUT(
            KC_ESC , KC_GRV , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   , /**/ KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_LBRC, KC_RBRC,
                     ...
                     KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , /**/ KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_ENT,
                                       KC_LCTL, KC_LALT, NUMB   , KC_SPC , /**/ KC_BSPC, ARROWS , KC_ENT , KC_ESC
    ),
    [_NUMBERS] = LAYOUT(
            _______, _______, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, /**/ KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS, KC_PLUS,
                     _______, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , /**/ KC_MINS, KC_EQL , _______, _______, _______, _______,
                     _______, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , /**/ KC_UNDS, KC_PLUS, _______, _______, _______, _______,
